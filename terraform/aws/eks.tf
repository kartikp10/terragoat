...
resource aws_iam_role "iam_for_eks" {
  ...
  tags = {
    yor_trace = "ed9f1366-5497-4a42-a327-645586e23d08"
  }
}
...
resource aws_vpc "eks_vpc" {
  ...
  tags = {
    ...
    yor_trace = "2a1b6729-fdd2-4f4a-ab3f-d01d50c8dc59"
  }
}
...
resource aws_subnet "eks_subnet1" {
  ...
  tags = {
    ...
    "kubernetes.io/cluster/$${local.eks_name.value}" = "shared"
    yor_trace                                        = "5f942f8f-536d-4b3f-9531-54a11749197b"
  }
}
...
resource aws_subnet "eks_subnet2" {
  ...
  tags = {
    ...
    "kubernetes.io/cluster/${local.eks_name.value}"  = "shared"
    "kubernetes.io/cluster/$${local.eks_name.value}" = "shared"
    yor_trace                                        = "d8a50909-fbbe-4db4-aba1-abc9afdf1006"
  }
}
...
resource aws_eks_cluster "eks_cluster" {
  ...
  tags = {
    yor_trace = "a158bfc9-5985-49d9-933e-e981c96c0f3e"
  }
}
