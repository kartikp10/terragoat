resource "aws_rds_cluster" "app1-rds-cluster" {
  ...
  tags = {
    yor_trace = "a1fe2cbd-cc60-48aa-8143-182eaded9ecc"
  }
}
...
resource "aws_rds_cluster" "app2-rds-cluster" {
  ...
  tags = {
    yor_trace = "6a5bf4e9-49f9-45e4-803c-4307d1bd5397"
  }
}
...
resource "aws_rds_cluster" "app3-rds-cluster" {
  ...
  tags = {
    yor_trace = "5b29684e-56eb-449e-85b7-4082036ed02a"
  }
}
...
resource "aws_rds_cluster" "app4-rds-cluster" {
  ...
  backup_retention_period = 15
  tags = {
    yor_trace = "ae6c0e29-0b6e-4351-93da-d1d7cdec2e8c"
  }
}
...
resource "aws_rds_cluster" "app5-rds-cluster" {
  ...
  backup_retention_period = 15
  tags = {
    yor_trace = "7b58af61-a488-491c-a55d-de20c7171c68"
  }
}
...
resource "aws_rds_cluster" "app6-rds-cluster" {
  ...
  backup_retention_period = 15
  tags = {
    yor_trace = "4372aaaa-26ec-42b2-bd61-1bcfced4f410"
  }
}
...
resource "aws_rds_cluster" "app7-rds-cluster" {
  ...
  tags = {
    yor_trace = "1b9de2a2-4103-46de-98d2-ea970962439a"
  }
}
...
resource "aws_rds_cluster" "app8-rds-cluster" {
  ...
  backup_retention_period = 25
  tags = {
    yor_trace = "e26a3af9-ad8b-4f7f-b652-997014e9cf22"
  }
}
...
resource "aws_rds_cluster" "app9-rds-cluster" {
  ...
  backup_retention_period = 25
  tags = {
    yor_trace = "834b46a7-575e-4335-addb-f990f37641a7"
  }
}
