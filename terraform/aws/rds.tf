resource "aws_rds_cluster" "app1-rds-cluster" {
  ...
  tags = {
    yor_trace = "f2b96303-2d10-43fa-a6c3-c613cf891361"
  }
}
...
resource "aws_rds_cluster" "app2-rds-cluster" {
  ...
  tags = {
    yor_trace = "7842adb8-0a73-4659-a08a-f3944dc34d97"
  }
}
...
resource "aws_rds_cluster" "app3-rds-cluster" {
  ...
  tags = {
    yor_trace = "92690922-a6fb-4f1a-8f42-93f802efe309"
  }
}
...
resource "aws_rds_cluster" "app4-rds-cluster" {
  ...
  backup_retention_period = 15
  tags = {
    yor_trace = "a9a505a4-94d6-474f-a721-27d046448e46"
  }
}
...
resource "aws_rds_cluster" "app5-rds-cluster" {
  ...
  backup_retention_period = 15
  tags = {
    yor_trace = "bff44393-7644-46f9-b961-df0469acf5cb"
  }
}
...
resource "aws_rds_cluster" "app6-rds-cluster" {
  ...
  backup_retention_period = 15
  tags = {
    yor_trace = "000f126f-6331-464f-b2c6-ed9ee033c927"
  }
}
...
resource "aws_rds_cluster" "app7-rds-cluster" {
  ...
  tags = {
    yor_trace = "f6d05cd5-cfa8-4a08-92b1-1edfe7b12851"
  }
}
...
resource "aws_rds_cluster" "app8-rds-cluster" {
  ...
  backup_retention_period = 25
  tags = {
    yor_trace = "e42551e4-44e1-407f-9e33-2865da8a692b"
  }
}
...
resource "aws_rds_cluster" "app9-rds-cluster" {
  ...
  backup_retention_period = 25
  tags = {
    yor_trace = "8a253099-5743-45a1-a441-a9dca01e20e1"
  }
}
