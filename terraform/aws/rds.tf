resource "aws_rds_cluster" "app1-rds-cluster" {
  ...
  tags = {
    yor_trace = "997b2133-b682-4509-8f1c-0dca2d2fc1f0"
  }
}
...
resource "aws_rds_cluster" "app2-rds-cluster" {
  ...
  tags = {
    yor_trace = "c5d8f86f-51d7-4963-9cf7-10baeb2db6d8"
  }
}
...
resource "aws_rds_cluster" "app3-rds-cluster" {
  ...
  tags = {
    yor_trace = "92598844-9d7a-497f-b1d9-d35ae6437146"
  }
}
...
resource "aws_rds_cluster" "app4-rds-cluster" {
  ...
  backup_retention_period = 15
  tags = {
    yor_trace = "223d547f-be3d-4655-a1ce-7eca31262673"
  }
}
...
resource "aws_rds_cluster" "app5-rds-cluster" {
  ...
  backup_retention_period = 15
  tags = {
    yor_trace = "5de0d850-b7da-457c-9043-a57aa276a9e7"
  }
}
...
resource "aws_rds_cluster" "app6-rds-cluster" {
  ...
  backup_retention_period = 15
  tags = {
    yor_trace = "e6a48684-b9ec-41b5-a051-89f9f70a1364"
  }
}
...
resource "aws_rds_cluster" "app7-rds-cluster" {
  ...
  tags = {
    yor_trace = "162b230d-b3fa-47d7-a0ca-dc3701f29d87"
  }
}
...
resource "aws_rds_cluster" "app8-rds-cluster" {
  ...
  backup_retention_period = 25
  tags = {
    yor_trace = "32aa993e-de9a-4a7a-af8c-d5eafe34e384"
  }
}
...
resource "aws_rds_cluster" "app9-rds-cluster" {
  ...
  backup_retention_period = 25
  tags = {
    yor_trace = "7ecc8de5-4ad7-4e34-aa6e-85171a093419"
  }
}
