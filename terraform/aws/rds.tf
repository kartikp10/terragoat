resource "aws_rds_cluster" "app1-rds-cluster" {
  ...
  tags = {
    yor_trace = "3d8a757a-861c-403c-b021-583f77fe15d1"
  }
}
...
resource "aws_rds_cluster" "app2-rds-cluster" {
  ...
  tags = {
    yor_trace = "29494709-7e79-41fa-be79-096a71e8a5f0"
  }
}
...
resource "aws_rds_cluster" "app3-rds-cluster" {
  ...
  tags = {
    yor_trace = "a635a33b-ded2-4786-9fcb-b79e226b7ba9"
  }
}
...
resource "aws_rds_cluster" "app4-rds-cluster" {
  ...
  backup_retention_period = 15
  tags = {
    yor_trace = "994b89bb-59f8-4de1-98ce-30378814651a"
  }
}
...
resource "aws_rds_cluster" "app5-rds-cluster" {
  ...
  backup_retention_period = 15
  tags = {
    yor_trace = "e206f285-f0c7-4a32-989f-71f7004e3053"
  }
}
...
resource "aws_rds_cluster" "app6-rds-cluster" {
  ...
  backup_retention_period = 15
  tags = {
    yor_trace = "ae964915-e9e6-4180-ac92-ff33e691d5db"
  }
}
...
resource "aws_rds_cluster" "app7-rds-cluster" {
  ...
  tags = {
    yor_trace = "3b37c884-c48c-4ec7-801e-f4ec97537c21"
  }
}
...
resource "aws_rds_cluster" "app8-rds-cluster" {
  ...
  backup_retention_period = 25
  tags = {
    yor_trace = "d0a491aa-bb0c-462c-927a-6d874a908784"
  }
}
...
resource "aws_rds_cluster" "app9-rds-cluster" {
  ...
  backup_retention_period = 25
  tags = {
    yor_trace = "676da14c-8a76-4aae-9272-c54a71178838"
  }
}
