resource "aws_rds_cluster" "app1-rds-cluster" {
  ...
  tags = {
    yor_trace = "4725fd25-514f-48bb-a99b-0a21e0b896c5"
  }
}
...
resource "aws_rds_cluster" "app2-rds-cluster" {
  ...
  tags = {
    yor_trace = "ed656a64-f972-4361-a768-20700625a2ab"
  }
}
...
resource "aws_rds_cluster" "app3-rds-cluster" {
  ...
  tags = {
    yor_trace = "f6072b15-8641-4fea-b1be-5d214f530efd"
  }
}
...
resource "aws_rds_cluster" "app4-rds-cluster" {
  ...
  backup_retention_period = 15
  tags = {
    yor_trace = "746cfc46-5f5b-4855-8f2b-4df8e279d711"
  }
}
...
resource "aws_rds_cluster" "app5-rds-cluster" {
  ...
  backup_retention_period = 15
  tags = {
    yor_trace = "4389e829-7ae0-4f00-b376-fdb636648e45"
  }
}
...
resource "aws_rds_cluster" "app6-rds-cluster" {
  ...
  backup_retention_period = 15
  tags = {
    yor_trace = "d0013b09-2375-4583-a4b8-895e89d33a50"
  }
}
...
resource "aws_rds_cluster" "app7-rds-cluster" {
  ...
  tags = {
    yor_trace = "d84321b4-eb45-482d-b3a1-77c05829c4e3"
  }
}
...
resource "aws_rds_cluster" "app8-rds-cluster" {
  ...
  backup_retention_period = 25
  tags = {
    yor_trace = "da87bc41-269f-419c-9371-1664e70c7315"
  }
}
...
resource "aws_rds_cluster" "app9-rds-cluster" {
  ...
  backup_retention_period = 25
  tags = {
    yor_trace = "5c9d3ffc-86f8-4d54-8f04-6c40e83ffc9c"
  }
}
