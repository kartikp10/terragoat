resource "aws_rds_cluster" "app1-rds-cluster" {
  ...
  tags = {
    yor_trace = "5003cfa6-ecc5-4f12-9a24-e494da150850"
  }
}
...
resource "aws_rds_cluster" "app2-rds-cluster" {
  ...
  tags = {
    yor_trace = "a1f09d83-91aa-46c5-8fea-413804237392"
  }
}
...
resource "aws_rds_cluster" "app3-rds-cluster" {
  ...
  tags = {
    yor_trace = "3372d893-8275-47d9-b6ae-1e74f0c65b42"
  }
}
...
resource "aws_rds_cluster" "app4-rds-cluster" {
  ...
  backup_retention_period = 15
  tags = {
    yor_trace = "be1c28dc-2df8-4bd4-9142-d509af05f553"
  }
}
...
resource "aws_rds_cluster" "app5-rds-cluster" {
  ...
  backup_retention_period = 15
  tags = {
    yor_trace = "b0a6333e-f433-479e-ab9b-4d13fd1cd321"
  }
}
...
resource "aws_rds_cluster" "app6-rds-cluster" {
  ...
  backup_retention_period = 15
  tags = {
    yor_trace = "9a502334-4538-45e6-a2f8-46ded816989d"
  }
}
...
resource "aws_rds_cluster" "app7-rds-cluster" {
  ...
  tags = {
    yor_trace = "1e3a16d2-76b7-411d-88f1-2fbe0f4bac0a"
  }
}
...
resource "aws_rds_cluster" "app8-rds-cluster" {
  ...
  backup_retention_period = 25
  tags = {
    yor_trace = "3817df95-7a7c-438b-988f-cab42b078191"
  }
}
...
resource "aws_rds_cluster" "app9-rds-cluster" {
  ...
  backup_retention_period = 25
  tags = {
    yor_trace = "724e6ac0-9e23-4b1e-8f94-641390c2a17b"
  }
}
